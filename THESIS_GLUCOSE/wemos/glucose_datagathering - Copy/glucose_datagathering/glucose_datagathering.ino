...
void loop() {
  ...
  else if (sensor.getVersion() == SENSORTYPE_AS7263)
  {
    ...
    data+=sensor.getCalibratedR();
    data+=",";
    data+=sensor.getCalibratedS();
    data+=",";
    data+=sensor.getCalibratedT();
    data+=",";
    data+=sensor.getCalibratedU();
    data+=",";
    data+=sensor.getCalibratedV();
    data+=",";
    data+=sensor.getCalibratedW();
