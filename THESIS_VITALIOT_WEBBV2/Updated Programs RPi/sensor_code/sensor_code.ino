...
uint8_t type;
String latitudeCoordinate = "0.0";
String longitudeCoordinate = "0.0";
...
void getGPSData()
{
  ...
  if (gps_success) {
    ...
    dtostrf(latitude, 6, 6, latChar);
    dtostrf(longitude, 6, 6, lonChar);

   // Serial.println(latChar);

    latitudeCoordinate = latChar;
    longitudeCoordinate = lonChar;

    Serial.println("Coordinates from Arduino: ");
