...
class Window(QtWidgets.QMainWindow):
    ...
    def enterButtonClicked(self):
        try:
            ...
            featureWeight=(totalArea**2)+(maxima**2)+(minima**2)
            linearRegWeight=round(-12.4166+0.0002*featureWeight,4)

            print(totalArea, maxima, minima)
            ...
            if mode == self.mode[0]:
                ...
                weightEstimated=self.imgObj.compWeight(fileName[fileName.rfind("/")+1:],"top")

            elif mode == self.mode[1]:
                print("Side mode selected.")
                
                weightEstimated=self.imgObj.compWeight(fileName[fileName.rfind("/")+1:],"side")
